// SHA-256 puro, sem dependência de window.crypto.subtle (indisponível em
// contexto não-seguro — o site roda em HTTP puro, sem TLS). Só usado pra
// buscar por CPF/CNPJ completo comparando hash com hash, nunca pra nada
// criptográfico sensível.
